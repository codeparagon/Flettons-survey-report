...
return new class extends Migration
{
    ...
    {
        Schema::create('survey_option_types', function (Blueprint $table) {
            $table->id();
            $table->string('key_name', 50)->unique()->comment('Unique identifier key (e.g., section_type, location, structure, material, defects, remaining_life)');
    ...
    {
        Schema::dropIfExists('survey_option_types');
    }
};
