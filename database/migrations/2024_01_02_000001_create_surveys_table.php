...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('surveys', function (Blueprint $table) {
            ...
            $table->string('over1650')->nullable();
            ...
            // =========================
            $table->string('inf_custom_VacantorOccupied')->nullable();
            $table->string('inf_custom_AnyExtensions')->nullable();
            $table->string('inf_custom_Garage')->nullable();
            $table->string('inf_custom_GarageLocation')->nullable();
            $table->string('inf_custom_Garden')->nullable();
            ...
            // =========================
            $table->string('inf_custom_SolicitorFirm')->nullable();
            ...
            // =========================
            $table->string('inf_custom_exchange_known')->nullable();
            $table->string('inf_custom_ExchangeDate')->nullable();
            ...
            // =========================
            $table->string('inf_option_IconfirmthatIhavereadandunderstandtheterms')->nullable();
            $table->text('inf_custom_infcustomSignature')->nullable();
            ...
            // =========================
            // Internal management fields (for admin/surveyor)
            // =========================
