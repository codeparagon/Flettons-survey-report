...
@section('title', 'Create Survey Level')
        ...
        <div class="col-12">
            <div class="page-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h1 class="page-title">Create Survey Level</h1>
            ...
            <form action="{{ route('admin.survey-levels.store') }}" 
                  method="POST">
                @csrf
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  name="description" 
                                  rows="3" 
                                  placeholder="Describe what this survey level covers...">{{ old('description', '') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
