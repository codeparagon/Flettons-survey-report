                        ...
                        @foreach($sections as $section)
                            <div class="section-item" onclick="toggleSection({{ $section->id }})">
                                <input type="checkbox" 
                                       ...
                                       {{ in_array($section->id, old('sections', $selectedSections ?? [])) ? 'checked' : '' }}>
                        ...
                        @foreach($accommodationTypes as $type)
                            <div class="section-item" onclick="toggleAccommodationType({{ $type->id }})">
                                <input type="checkbox" 
                                       ...
                                       {{ in_array($type->id, old('accommodation_types', $selectedAccommodationTypes ?? [])) ? 'checked' : '' }}>
                        ...
                        @foreach($contentSections as $contentSection)
                            <div class="section-item" onclick="toggleContentSection({{ $contentSection->id }})">
                                <input type="checkbox" 
                                       ...
                                       {{ in_array($contentSection->id, old('content_sections', $selectedContentSections ?? [])) ? 'checked' : '' }}>
